...
void testWorldChunkAppearance() {
  ...
  require(restored_appearance.isActive(0U) && restored_appearance.isWarm(1U) &&
  ...
  const auto restored_warm_progress = restored_appearance.revealProgress(1U);
  require(restored_appearance.revealProgress(0U) == 1.0 &&
              restored_warm_progress > 0.0 &&
              restored_warm_progress < sf::platform::world_chunk_prefetch_lead,
          "Checkpoint lookahead did not resume its normal gradual wave");
  restored_appearance.advance(room_zero, sf::platform::world_chunk_fade_seconds,
                              room_one, 10.0, 20.0);
  ...
  require(authored_prefetch.isActive(0U) && !authored_prefetch.isActive(1U) &&
          ...
          "origin");
  authored_prefetch.advance(room_zero,
  ...
  require(authored_prefetch.isActive(1U) && !authored_prefetch.isWarm(1U) &&
  ...
  const auto spatial_far = spatial_floor(0.5, far_depth, near_depth, far_depth);
  ...
  authored_prefetch.advance(room_one, sf::platform::world_chunk_fade_seconds);
