...
if(SF_BUILD_TESTS)
    ...
    sf_add_unit_test(sf_graphics_settings_tests
        tests/graphics_settings_tests.cpp)
    sf_add_unit_test(sf_r3000_runtime_tests tests/r3000_runtime_tests.cpp
        LIBRARIES sf::game)
    if(MSVC)
        target_link_options(sf_r3000_runtime_tests PRIVATE /STACK:4194304)
    endif()
    sf_add_unit_test(sf_bios_hle_tests tests/bios_hle_tests.cpp
        LIBRARIES sf::psx)
    ...
    sf_add_unit_test(sf_mdec_tests tests/mdec_tests.cpp
        LIBRARIES sf::psx)
    ...
    if(MOHU_SUPPORTED_ROM_CUE)
        add_test(NAME mohu_analog_pad_rom
            COMMAND mohu_analog_pad_probe "${MOHU_SUPPORTED_ROM_CUE}")
        set_tests_properties(mohu_analog_pad_rom PROPERTIES
            LABELS "rom;mohu;pad;analog;integration"
            TIMEOUT 600)
        add_test(NAME mohu_gameplay_rom
            COMMAND mohu_gameplay_probe "${MOHU_SUPPORTED_ROM_CUE}")
        set_tests_properties(mohu_gameplay_rom PROPERTIES
