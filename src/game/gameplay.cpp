...
void GameplaySession::updateMissionScripts(bool interact) noexcept {
  ...
  MissionScriptUpdateContext context{};
  context.actors = script_actors;
  context.player_x = player_state.x;
  context.player_y = player_state.y;
  context.player_z = player_state.z;
